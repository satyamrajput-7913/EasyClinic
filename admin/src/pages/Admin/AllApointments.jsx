        ...
        {appointments.map((item, index) => (
          <div key={index} className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover: bg-gray-50' >
            ...
            <div className='flex items-center gap-2'>
              <img className='w-10 bg-gray-300 rounded-full' src={item.userData.image} alt="" />
            ...
            <div className='flex items-center gap-2'>
              <img className='w-10 bg-gray-300 rounded-full' src={item.docData.image} alt="" />
            ...
            {item.cancelled
              ? <p className='text-red-400 text-xs-1.2 font-medium'>Cancelled</p>
              : item.isCompleted
                ...
                title='Click to cancel appointment'
